...
VALUES 
(1, 'Pasta Quattro Formaggi', 'Pasta with 4 types of cheese', 'Naestved Storcenter', CURRENT_TIMESTAMP() + INTERVAL 1 DAY, 2, 129.9, CURDATE()),
(2, 'Cheesecake', 'Cheesecake with salty caramel', 'Restaurant Nimb, Cph', CURRENT_TIMESTAMP() + INTERVAL 5 DAY, 3, 259.9, CURDATE() - INTERVAL 7 DAY),
(3, 'Pumpkin soup', 'Cream-soup from pumpkin', 'IKEA Taastrup', CURRENT_TIMESTAMP() + INTERVAL 2 HOUR, 8, 10.0, CURDATE()),
(4, 'Rød grød med fløde', 'Rød grød med fløde', 'Cafe Vivaldi, Naestved', CURRENT_TIMESTAMP() + INTERVAL 3 DAY, 3, 49.9, CURDATE() - INTERVAL 2 DAY),
(5, 'Salat Box', 'Salat from seasonal vegetables', 'Restaurant Flammen, Naestved', CURRENT_TIMESTAMP() + INTERVAL 2 DAY, 5, 19.9, CURDATE() - INTERVAL 1 DAY);
INSERT INTO reservation (id, number_of_guests, meal_id, created_date, contact_phonenumber, contact_name, contact_email)
VALUES 
(1, 1, 2, CURDATE() - INTERVAL 2 DAY, '79682896', 'Apolina', 'app582olina@icloud.com'),
...
VALUES 
(1, 'So-so', 'I thought I bought pasta with 4 types of cheese but it was paste with 3 types of cheese and one spoon of sour-cream', 1, 2, CURDATE() + INTERVAL 2 DAY),
